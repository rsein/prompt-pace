...
type PersonalRun = { km: number; time_sec: number; created_at: string };
...
export default function StatsClient({ stats, months, runs }: { stats: Stats; months: MonthData[]; runs: PersonalRun[] }) {
  ...
  return (
    <div className="max-w-md mx-auto pb-16 px-5 pt-6">
      ...
      <div className="text-xs font-extrabold uppercase tracking-wide text-muted mb-2.5">Histórico completo</div>
